...
- Deploy curb to Cecilia (.96) with systemd auto-start
...
- Add NLP intent routing: 'store file' / 'get asset'
- Create Curb Agent persona with RoundTrip auto-chat
- Integrate with RoadMem for persistent state across restarts
- Add Codex solution entries for common curb operations
- Build blackroad-operator CLI commands: `br curb status|deploy|logs`
...
- Contribute BlackRoad improvements back to upstream MinIO
